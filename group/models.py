...
class GroupTeacher(models.Model):
    user = models.ForeignKey('account.User', on_delete=models.CASCADE, related_name='group_teacher')
    group = models.ForeignKey('course.Group', on_delete=models.CASCADE, related_name='group_teacher')
